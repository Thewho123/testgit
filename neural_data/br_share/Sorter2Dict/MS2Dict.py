...
def MSShare(ParseResults, wavedict ,
                 RecordingParam, sampling_rate):
    
    SpikeDict = {}
    SpikeDict['Mountain4_spike_train'] = 'IronClust_spike_train'
...
class MSSorter2Dict(BaseSorter2Dict):
    ...
    def Sorter2Dict(cls, sorter_dir, wavedict = {},
        ...
        return MSShare(self._ParseResults, wavedict = wavedict,
